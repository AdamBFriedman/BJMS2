...
const useStyles = makeStyles((theme) => ({
  ...
  meetJoeyWrapper: {
    background: `linear-gradient(to bottom left, ${theme.palette.secondary.main}, ${theme.palette.grey.main})`,
  ...
  h1: {
    ...
    background: `linear-gradient(to top left, ${theme.palette.grey.main}, ${theme.palette.secondary.light}, ${theme.palette.grey.main})`,
